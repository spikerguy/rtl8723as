...
###################### Platform Related #######################
CONFIG_PLATFORM_RK3229 = y
CONFIG_PLATFORM_RK3288 = n
CONFIG_PLATFORM_AML905X3 = n
CONFIG_PLATFORM_AML905W = n
...
ifeq ($(CONFIG_PLATFORM_RK3229), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
EXTRA_CFLAGS += -DCONFIG_CONCURRENT_MODE
EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT
EXTRA_CFLAGS += -DCONFIG_P2P_IPS
ARCH := arm
CROSS_COMPILE := /home/pc/sdk/sdk-all/rockchip/rk3229/rk3229_ANDROID7.1_20200320/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/arm-eabi-
KSRC := /home/pc/sdk/sdk-all/rockchip/rk3229/rk3229_ANDROID7.1_20200320/kernel
endif

ifeq ($(CONFIG_PLATFORM_RK3288), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
EXTRA_CFLAGS += -DCONFIG_CONCURRENT_MODE
EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT
EXTRA_CFLAGS += -DCONFIG_P2P_IPS
ARCH := arm
CROSS_COMPILE := /home/yaya/D/Workspace/CyberQuantum/JinHaoYue/rk3288/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.8/bin/arm-linux-androideabi-
KSRC := /home/yaya/D/Workspace/CyberQuantum/JinHaoYue/rk3288/kernel
endif

ifeq ($(CONFIG_PLATFORM_AML905X3), y)
...
ARCH := arm
CROSS_COMPILE := /home/yaya/D/Workspace/CyberQuantum/JinHaoYue/amls905x3/SDK/20191101-0tt-asop/android9.0/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-
KSRC := /home/yaya/D/Workspace/CyberQuantum/JinHaoYue/amls905x3/SDK/20191101-0tt-asop/android9.0/out/target/product/u202/obj/KERNEL_OBJ/
ifeq ($(CONFIG_SDIO_HCI), y)
...
ifeq ($(CONFIG_PLATFORM_AML905W), y)
EXTRA_CFLAGS += -Wno-error=date-time
EXTRA_CFLAGS += -DCONFIG_PLATFORM_AML_S905
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN -fno-pic
EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DCONFIG_CONCURRENT_MODE
...
EXTRA_CFLAGS += -DCONFIG_RADIO_WORK
ARCH := arm64
CROSS_COMPILE := /home/yaya/E/Amlogic/905w/n-amlogic/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
KSRC := /home/yaya/E/Amlogic/905w/n-amlogic/out/target/product/p281/obj/KERNEL_OBJ/
ifeq ($(CONFIG_SDIO_HCI), y)
EXTRA_CFLAGS += -DCONFIG_PLATFORM_OPS
_PLATFORM_FILES += platform/platform_AML_S905_sdio.o
endif
...
EXTRA_CFLAGS += -DCONFIG_ANDROID_4_2
else
...
EXTRA_CFLAGS += -DCONFIG_P2P_IPS -DCONFIG_QOS_OPTIMIZATION
ARCH := arm
# Cross compile setting for Android 4.2 SDK-Miracast-sink
...
obj-$(CONFIG_RTL8723AS) := $(MODULE_NAME).o


else

export CONFIG_RTL8723AS = m
